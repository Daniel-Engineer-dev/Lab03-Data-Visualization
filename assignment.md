...
Mỗi thành viên chịu trách nhiệm tạo **một file Power BI cá nhân**, gồm **2 biểu đồ chính** và phần phân tích cho mục tiêu được giao.
...
| :--------------------- | :----------------------------- | :------------------------------------------------------------------------------------- |
| **Lê Lâm Trí Đức**     | `powerbi/23120237_report.pbix` | Line chart xu hướng theo thời gian; heatmap theo ngày và giờ; 3-4 nhận xét             |
| **Hoàng Quốc Việt**    | `powerbi/23120189_report.pbix` | Stacked bar theo loại đường; matrix theo thời tiết và ánh sáng; 3-4 nhận xét           |
| **Nguyễn Lê Thế Vinh** | `powerbi/23120190_report.pbix` | Bar chart theo loại phương tiện; stacked column theo nhóm tuổi người lái; 3-4 nhận xét |
| **Phạm Quang Vinh**    | `powerbi/23120202_report.pbix` | Stacked bar thương vong theo nhóm tuổi; bar chart theo vai trò tham gia; 3-4 nhận xét  |

#### Công việc chung của mỗi thành viên

- Tạo đúng hai biểu đồ đã được phân công.
- Đặt tiêu đề, nhãn, đơn vị và màu sắc dễ đọc.
- Kiểm tra số liệu và bộ lọc trên từng biểu đồ.
- Chụp một ảnh ghép chứa hai biểu đồ.
- Viết 3-4 nhận xét có căn cứ trực tiếp từ số liệu.
...
- Mỗi file có đủ hai biểu đồ và nhận xét.
...
- Dashboard có KPI tổng quan, 8 biểu đồ chính và slicer phù hợp.
...
| **18/06 - 23:59** | Bốn file `.pbix` cá nhân, 8 biểu đồ, ảnh ghép và nội dung Mục 4 | Cả nhóm              |
...
- [ ] Mỗi thành viên có đúng hai biểu đồ và 3-4 nhận xét.
- [ ] Mục 4 đã có đầy đủ ảnh và nội dung phân tích.
- [ ] Dashboard tổng có KPI, 8 biểu đồ chính và slicer.
