...
Để làm quen với quy trình trên, nhóm đã thực hiện thử nghiệm trên một bộ dữ liệu đơn giản (ví dụ: danh sách bán hàng nội bộ của một cửa hàng nhỏ). Các bước thực hiện bao gồm:
\begin{enumerate}
    \item Nạp file Excel dữ liệu bán hàng vào Power BI Desktop.
    \item Dùng Power Query xóa các dòng trống và định dạng lại cột \texttt{Ngày bán} về kiểu \texttt{Date}.
    \item Tạo một measure tính tổng doanh thu bằng DAX: \texttt{Total Sales = SUM(Sales[Amount])}.
